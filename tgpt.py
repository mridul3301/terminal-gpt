...
def read_config() -> any:
  ...
  tgpt_path = os.path.abspath(__file__)
  prompt_path = os.path.dirname(tgpt_path)

  config_file = os.path.join(prompt_path, "tgpt.yaml")
...
def print_usage():
  ...
  print("Current configuration per tgpt.yaml:")
...
if __name__ == "__main__":
  ...
  tgpt = ""                  # user's answer to safety switch (-a) question y/n
  ...
  # single string. So, the user can just type tgpt what is my name?
